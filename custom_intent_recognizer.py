...
class CustomIntentRecognizer(Component):
    ...
    @classmethod
    def load(cls, meta: Dict[Text, Any], mode
    l_dir: Text = None, model_metadata: Metadata = None, 

    cached_component: Optional["Component"] = None, **kwargs: Any) -> "Component":
